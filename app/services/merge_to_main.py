        ...
        for group in batch.get("groups", []) or []:
            for row in group.get("rows", []) or []:
                rows.append({
                    ...
                    "col_f": row.get("col_f"),
                    "col_j": row.get("col_j"),
                    "effective_h_raw": row.get("effective_h_raw"),
                    "effective_h": row.get("effective_h"),
                    "needed_qty_raw": row.get("needed_qty_raw"),
                    "needed_qty": row.get("needed_qty"),
