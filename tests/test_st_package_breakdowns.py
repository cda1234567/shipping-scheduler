...
class StPackageBreakdownTests(InMemoryDbTestCase):
    ...
    def test_build_missing_moq_package_rows_uses_st_stock_as_reference(self):
        ...
        self.assertEqual(rows[0]["st_stock_qty"], 1000)
        self.assertEqual(rows[0]["package_sum"], 1000)
        self.assertTrue(rows[0]["matches_st_stock"])
